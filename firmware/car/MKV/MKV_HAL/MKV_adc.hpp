...
class MKV_ADC : public halina::ADC{
public:
    ...
    public:
        Sample (MKV_PORT& pinMux, ChannelSingleEnded channel): pinMux(pinMux), channel(channel){
...
public:
    MKV_ADC(HSADC_Type* baseAdc, void (*converterAHandler)(uint8_t), void (*converterBHandler)(uint8_t));
