...
ALIGNED(4) const uint8_t USB_DeviceDescriptor[] = {
    ...
    WBVAL(0x0200u), /* 2.0 */           /* bcdUSB */
    0xff,                              /* bDeviceClass */
    0x01,                              /* bDeviceSubClass */
    0x00,                              /* bDeviceProtocol */
    USB_MAX_PACKET0,                   /* bMaxPacketSize0 */
    WBVAL(0xb1acu),                     /* idVendor */
    WBVAL(0xf000u),                     /* idProduct */
    WBVAL(0x0100u), /* 1.00 */          /* bcdDevice */
    0x01,                              /* iManufacturer */
    0x02,                              /* iProduct */
    0x03,                              /* iSerialNumber */
...
ALIGNED(4) const uint8_t USB_FSConfigDescriptor[] = {
    ...
    USB_ENDPOINT_IN(1u),         /* bEndpointAddress */
    USB_ENDPOINT_TYPE_INTERRUPT,       /* bmAttributes */
    WBVAL(0x0010u),                 /* wMaxPacketSize */
    0x02,          /* 2ms */           /* bInterval */
    ...
    USB_ENDPOINT_DESC_SIZE,            /* bLength */
    USB_ENDPOINT_DESCRIPTOR_TYPE,      /* bDescriptorType */
    USB_ENDPOINT_OUT(2u),        /* bEndpointAddress */
    ...
    USB_ENDPOINT_DESC_SIZE,            /* bLength */
    USB_ENDPOINT_DESCRIPTOR_TYPE,      /* bDescriptorType */
    USB_ENDPOINT_IN(2u),         /* bEndpointAddress */
    USB_ENDPOINT_TYPE_BULK,            /* bmAttributes */
    WBVAL(USB_DEV_BUFSIZE),            /* wMaxPacketSize */
    0x00,                              /* bInterval: ignore for Bulk transfer */
    /* Terminator */
...
ALIGNED(4) const uint8_t USB_StringDescriptor[] = {
    ...
    WBVAL(0x0409u), /* US English */    /* wLANGID */
