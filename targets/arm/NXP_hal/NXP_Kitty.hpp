...
private:
    ...
    NXP_GPIO uartRxPin = {PORTA, GPIOA, 14U, halina::GPIO::Mode::INPUT};
    NXP_GPIO uartTxPin = {PORTA, GPIOA, 15U, halina::GPIO::Mode::OUTPUT};
    ...
    NXP_PORT uartRXmux = {PORTA, 14U, 0x03};
    NXP_PORT uartTXmux = {PORTA, 15U, 0x03};
