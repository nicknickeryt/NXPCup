...
NXP_GPIO::Interrupt NXP_GPIO::portBInterrupts[32];
NXP_GPIO::Interrupt NXP_GPIO::portCInterrupts[32];
NXP_GPIO::Interrupt NXP_GPIO::portDInterrupts[32];
NXP_GPIO::Interrupt NXP_GPIO::portEInterrupts[32];
...
void PORTB_IRQHandler(void) {
    callFunction(PORTB, NXP_GPIO::portBInterrupts);
}

void PORTC_IRQHandler(void) {
    callFunction(PORTC, NXP_GPIO::portCInterrupts);
}
...
void PORTE_IRQHandler(void) {
    callFunction(PORTE, NXP_GPIO::portEInterrupts);
}
}
